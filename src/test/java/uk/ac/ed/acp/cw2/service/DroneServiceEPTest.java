...
/**
 * Specification-Based (Black-Box) Techniques: Equivalence Partitioning (EP)
 */
...
public class DroneServiceEPTest {
    ...
    @Nested
    @DisplayName("queryAvailableDrones(): Equivalence Partitioning")
    class QueryAvailableDronesPartitions {
